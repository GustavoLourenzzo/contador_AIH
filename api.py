...
import cv2
import numpy as np
import utils #import visualization_utils as vis_util

# Variables  utils.visualization_utils
        ...
        with detection_graph.as_default():
          with tf.Session(graph=detection_graph) as sess:
            ...
            while(cap.isOpened()):
                ...
                counter, csv_line, counting_mode = utils.visualization_utils.visualize_boxes_and_labels_on_image_array_x_axis(cap.get(1),
                                                                                                             input_frame,
                                                                                                             1,
        ...
        with detection_graph.as_default():
          with tf.Session(graph=detection_graph) as sess:
            ...
            while(cap.isOpened()):
               ...
               # Visualization of the results of a detection.        
                counter, csv_line, counting_mode = utils.visualization_utils.visualize_boxes_and_labels_on_image_array_y_axis(cap.get(1),
                                                                                                             input_frame,
                                                                                                             2,
                                                                                                             is_color_recognition_enabled,
                                                                                                             np.squeeze(boxes),
        ...
        with detection_graph.as_default():
          with tf.Session(graph=detection_graph) as sess:
            ...
            while(cap.isOpened()):
                ...
                # Visualization of the results of a detection.        
                counter, csv_line, counting_mode = utils.visualization_utils.visualize_boxes_and_labels_on_image_array(cap.get(1),
                                                                                                      input_frame,
                                                                                                      1,
                                                                                                      is_color_recognition_enabled,
                                                                                                      np.squeeze(boxes),
        ...
        with detection_graph.as_default():
          with tf.Session(graph=detection_graph) as sess:
            ...
            while(cap.isOpened()):
                ...
                # Visualization of the results of a detection.        
                counter, csv_line, the_result = utils.visualization_utils.visualize_boxes_and_labels_on_image_array(cap.get(1),
                                                                                                      input_frame,
                                                                                                      1,
                                                                                                      is_color_recognition_enabled,
                                                                                                      np.squeeze(boxes),
...
def single_image_object_counting(input_video, detection_graph, category_index, is_color_recognition_enabled):     
        ...
        # Visualization of the results of a detection.        
        counter, csv_line, counting_mode = utils.visualization_utils.visualize_boxes_and_labels_on_single_image_array(1,input_frame,
                                                                                              1,
                                                                                              is_color_recognition_enabled,
                                                                                              np.squeeze(boxes),
                                                                                              np.squeeze(classes).astype(np.int32),
